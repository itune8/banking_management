...
if (isset($_POST['create_account'])) {
  ...
  $query = "INSERT INTO bm_clients (name, national_id, client_number, phone, email, password, address) VALUES (?,?,?,?,?,?,?)";
        ...
        <div class="card-body login-card-body">
          ...
          <form method="post">
            ...
            <div class="input-group mb-3" style="display:none">
              ...
              <input type="text" name="client_number" value="BM-CLIENT-<?php echo $_Number; ?>" class="form-control" placeholder="Client Number">
              <div class="input-group-append">
                <div class="input-group-text">
