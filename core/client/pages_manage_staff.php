...
if (isset($_GET['fireStaff'])) {
  ...
  $adn = "DELETE FROM  bm_staff  WHERE client_id = ?";
  ...
  if ($stmt) {
    $info = "Banking Management Staff Account Deleted";
  } else {
    $err = "Try Again Later";
  }
}
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Banking Management Staffs</h1>
            </div>
            <div class="col-sm-6">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                    //fetch all Banking Management staffs
                    $ret = "SELECT * FROM  bm_staff ORDER BY RAND() ";
