    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Banking Management Advanced Reporting : Withdrawal</h1>
            </div>
            <div class="col-sm-6">
                ...
                <table id="export" class="table table-bordered table-striped">
                  <thead>
                    <tr>
                      ...
                      <th>Acc Owner</th>
                      <th>Receiving Acc No</th>
                      <th>Receiving Acc Holder</th>
                      <th>Timestamp</th>
                  ...
                  <tbody>
                    ...
                    $client_id = $_SESSION['client_id'];
                    $ret = "SELECT * FROM  bm_Transactions  WHERE tr_type = 'Transfer'AND client_id =? ";
