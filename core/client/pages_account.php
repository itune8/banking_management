...
if (isset($_POST['update_client_account'])) {
    ...
    $query = "UPDATE  bm_clients SET name=?, national_id=?, phone=?, email=?, address=?, profile_pic=? WHERE client_id = ?";
    $stmt = $mysqli->prepare($query);
    //bind paramaters
    $rc = $stmt->bind_param('sssssss', $name, $national_id, $phone, $email,  $address, $profile_pic, $client_id);
    $stmt->execute();
...
if (isset($_POST['change_client_password'])) {
    ...
    $query = "UPDATE bm_clients  SET password=? WHERE  client_number=?";
    $stmt = $mysqli->prepare($query);
    //bind paramaters
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item"><a href="pages_manage_clients.php">Banking Management Clients</a></li>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="card card-primary card-outline">
                                    <div class="card-body box-profile">
                                        ...
                                        <p class="text-muted text-center">Client @Banking Management </p>
