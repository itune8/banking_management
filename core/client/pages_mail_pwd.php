...
if (isset($_POST['reset_password'])) {
    ...
    //update password
    $query = "UPDATE  bm_clients SET password=? WHERE email=? ";
    $update_password = "UPDATE bm_password_resets SET reset_status=? WHERE id =? ";
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <?php
            $email = $_GET['email'];
            $ret = "SELECT * FROM  bm_clients WHERE email = ?  ";
            ...
            ?>
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1>Reset Banking Management User <?php echo $row->name; ?> Password</h1>
                            </div>
                            <div class="col-sm-6">
