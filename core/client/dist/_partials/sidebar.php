<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  ?>
      ...
      <a href="pages_dashboard.php" class="brand-link">
        <img src="../admin/dist/img/<?php echo $sys->sys_logo;?>" alt="Banking Management Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="pages_open_acc.php" class="nav-link">
                    ...
                    <p>Open Banking Management Acc</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="pages_manage_acc_openings.php" class="nav-link">
                    <i class="fas fa-cog nav-icon"></i>
                    <p>My Banking Management Accounts</p>
                  </a>
                </li>
              </ul>
            </li>
            <!--./ Banking Management Acounts-->
