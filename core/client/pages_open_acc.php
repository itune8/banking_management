...
if (isset($_POST['open_account'])) {
    ...
    $query = "INSERT INTO bm_bankAccounts (acc_name, account_number, acc_type, acc_rates, acc_status, acc_amount, client_id, client_name, client_national_id, client_phone, client_number, client_email, client_adr) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)";
    ...
    if ($stmt) {
        $success = "Banking Management Account Opened";
    } else {
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    <div class="wrapper">
        ...
        <?php
        $client_id = $_SESSION['client_id'];
        $ret = "SELECT * FROM  bm_clients WHERE client_id = ? ";
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1>Open <?php echo $row->name; ?> Banking Management Account</h1>
                            </div>
                            <div class="col-sm-6">
