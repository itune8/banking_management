...
if (isset($_GET['deleteClient'])) {
  ...
  $adn = "DELETE FROM  bm_clients  WHERE client_id = ?";
  ...
  if ($stmt) {
    $info = "Banking Management Client Account Deleted";
  } else {
    $err = "Try Again Later";
  }
}
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Banking Management Clients</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="pages_dashboard.php">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="pages_manage_clients.php">Banking Management Staffs</a></li>
