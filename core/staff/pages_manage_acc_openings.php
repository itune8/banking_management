...
if (isset($_GET['deleteBankAcc'])) {
  ...
  $adn = "DELETE FROM  bm_bankAccounts  WHERE account_id = ?";
  ...
  if ($stmt) {
    $info = "Banking Management Account Closed";
  } else {
    $err = "Try Again Later";
  }
}
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Manage Banking Management Accounts</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="pages_dashboard.php">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="pages_manage_acc_openings.php">Banking Management Accounts</a></li>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                    //fetch all bm_Accs
                    $ret = "SELECT * FROM  bm_bankAccounts ORDER BY RAND() ";
