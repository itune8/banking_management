...
if (isset($_POST['create_staff_account'])) {
    ...
    $query = "INSERT INTO bm_clients (name, national_id, client_number, phone, email, password, address, profile_pic) VALUES (?,?,?,?,?,?,?,?)";
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Create Banking Management Client Account</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="pages_dashboard.php">Dashboard</a></li>
                                <li class="breadcrumb-item"><a href="pages_add_client.php">Banking Management Clients</a></li>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class=" col-md-6 form-group">
                                                ...
                                                ?>
                                                <input type="text" readonly name="client_number" value="BM-CLIENT-<?php echo $_Number; ?>" class="form-control" id="exampleInputPassword1">
                                            </div>
                                        </div>
