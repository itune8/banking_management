...
if (isset($_POST['login'])) {
  ...
  $stmt = $mysqli->prepare("SELECT email, password, staff_id  FROM bm_staff  WHERE email=? AND password=?"); //sql to log in user
    ...
    <div class="login-box">
      ...
      <div class="card">
        <div class="card-body login-card-body">
          <p class="login-box-msg">Sign In To Start Staff Session</p>
