...
if (isset($_POST['update_acc_type'])) {
    ...
    $query = "UPDATE  bm_Acc_types SET name=?, description=?, rate=? WHERE code=? ";
    ...
    if ($stmt) {
        $success = "Banking Management Account Category Updated";
    } else {
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    <div class="wrapper">
        ...
        <?php
        //fetch a bm_Acc_types
        $code = $_GET['code'];
        $ret = "SELECT * FROM  bm_Acc_types WHERE code = ? ";
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item"><a href="pages_update_accs.php">Banking Management Accounts</a></li>
