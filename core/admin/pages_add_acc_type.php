...
if (isset($_POST['create_acc_type'])) {
    ...
    $query = "INSERT INTO bm_Acc_types (name, description, rate, code) VALUES (?,?,?,?)";
    ...
    if ($stmt) {
        $success = "Banking Management Account Category Created";
    } else {
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Create Banking Management Account Categories</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="pages_dashboard.php">Dashboard</a></li>
                                <li class="breadcrumb-item"><a href="pages_add_acc_type.php">Banking Management</a></li>
