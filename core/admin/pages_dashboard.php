...
if (isset($_GET['Clear_Notifications'])) {
  ...
  $adn = "DELETE FROM  bm_notifications  WHERE notification_id = ?";
...
$result = "SELECT count(*) FROM bm_clients";
...
//return total number of Banking Management Staffs
$result = "SELECT count(*) FROM bm_staff";
$stmt = $mysqli->prepare($result);
$stmt->execute();
...
//return total number of Banking Management Account Types
$result = "SELECT count(*) FROM bm_Acc_types";
$stmt = $mysqli->prepare($result);
$stmt->execute();
$stmt->bind_result($bm_AccsType);
$stmt->fetch();
$stmt->close();

//return total number of Banking Management Accounts
$result = "SELECT count(*) FROM bm_bankAccounts";
$stmt = $mysqli->prepare($result);
$stmt->execute();
$stmt->bind_result($bm_Accs);
$stmt->fetch();
$stmt->close();

//return total number of Banking Management Deposits
$result = "SELECT SUM(transaction_amt) FROM bm_Transactions WHERE  tr_type = 'Deposit' ";
$stmt = $mysqli->prepare($result);
$stmt->execute();
$stmt->bind_result($bm_deposits);
$stmt->fetch();
$stmt->close();

//return total number of Banking Management Withdrawals
$result = "SELECT SUM(transaction_amt) FROM bm_Transactions WHERE  tr_type = 'Withdrawal' ";
$stmt = $mysqli->prepare($result);
$stmt->execute();
$stmt->bind_result($bm_withdrawal);
$stmt->fetch();
$stmt->close();



//return total number of Banking Management Transfers
$result = "SELECT SUM(transaction_amt) FROM bm_Transactions WHERE  tr_type = 'Transfer' ";
$stmt = $mysqli->prepare($result);
$stmt->execute();
$stmt->bind_result($bm_Transfers);
$stmt->fetch();
$stmt->close();

//return total number of  Banking Management initial cash->balances
$result = "SELECT SUM(transaction_amt) FROM bm_Transactions ";
$stmt = $mysqli->prepare($result);
$stmt->execute();
...
$TotalBalInAccount = ($bm_deposits)  - (($bm_withdrawal) + ($bm_Transfers));
            ...
            <div class="col-12 col-sm-6 col-md-3">
              <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                  ...
                  <span class="info-box-number"><?php echo $bm_AccsType; ?></span>
                </div>
              </div>
            </div>
            <!-- /.Banking Management Acc types -->

            <!--Banking Management Accounts-->
            <div class="col-12 col-sm-6 col-md-3">
              <div class="info-box mb-3">
                <span class="info-box-icon bg-warning elevation-1"><i class="fas fa-users"></i></span>
                <div class="info-box-content">
                  <span class="info-box-text">Accounts</span>
                  <span class="info-box-number"><?php echo $bm_Accs; ?></span>
                </div>
              </div>
            </div>
            <!-- Banking Management Acc-->
          </div>

          <div class="row">
            <!--Banking Management Deposits -->
            <div class="col-12 col-sm-6 col-md-3">
              <div class="info-box">
            ...
            <div class="col-12 col-sm-6 col-md-3">
              <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                  ...
                  <span class="info-box-number">Rs <?php echo $bm_withdrawal; ?> </span>
                </div>
              </div>
            </div>
            <!-- Withdrawals-->
            ...
            <div class="col-12 col-sm-6 col-md-3">
              <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                  ...
                  <span class="info-box-number">Rs <?php echo $bm_Transfers; ?></span>
                </div>
              </div>
            </div>
            <!-- /.Transfers-->
                  ...
                  <div class="row">
                    <div class="col-sm-3 col-6">
                      <div class="description-block border-right">
                        <h5 class="description-header">Rs <?php echo $bm_deposits; ?></h5>
                    ...
                    <div class="col-sm-3 col-6">
                      <div class="description-block border-right">
                        <h5 class="description-header">Rs <?php echo $bm_withdrawal; ?></h5>
                    ...
                    <div class="col-sm-3 col-6">
                      <div class="description-block border-right">
                        <h5 class="description-header">Rs <?php echo $bm_Transfers; ?> </h5>
                  ...
                  <div class="table-responsive">
                    <table class="table m-0">
                      ...
                      <tbody>
                        ...
                        $ret = "SELECT * FROM `bm_Transactions` ORDER BY `bm_Transactions`.`created_at` DESC ";
        ...
        data: [{
          ...
          dataPoints: [{
              y: <?php
                  ...
                  $result = "SELECT count(*) FROM bm_bankAccounts WHERE  acc_type ='Savings' ";
                  $stmt = $mysqli->prepare($result);
                  $stmt->execute();
...

            {
              y: <?php
                  ...
                  $result = "SELECT count(*) FROM bm_bankAccounts WHERE  acc_type =' Retirement' ";
                  $stmt = $mysqli->prepare($result);
                  $stmt->execute();
...

            {
              y: <?php
                  ...
                  $result = "SELECT count(*) FROM bm_bankAccounts WHERE  acc_type ='Recurring deposit' ";
                  $stmt = $mysqli->prepare($result);
                  $stmt->execute();
...

            {
              y: <?php
                  ...
                  $result = "SELECT count(*) FROM bm_bankAccounts WHERE  acc_type ='Fixed Deposit Account' ";
                  $stmt = $mysqli->prepare($result);
                  $stmt->execute();
...

            {
              y: <?php
                  ...
                  $result = "SELECT count(*) FROM bm_bankAccounts WHERE  acc_type ='Current account' ";
                  $stmt = $mysqli->prepare($result);
                  $stmt->execute();
        ...
        data: [{
          ...
          dataPoints: [{
              y: <?php
                  ...
                  $result = "SELECT count(*) FROM bm_Transactions WHERE  tr_type ='Withdrawal' ";
                  $stmt = $mysqli->prepare($result);
                  $stmt->execute();
...

            {
              y: <?php
                  ...
                  $result = "SELECT count(*) FROM bm_Transactions WHERE  tr_type ='Deposit' ";
                  $stmt = $mysqli->prepare($result);
                  $stmt->execute();
...

            {
              y: <?php
                  //return total number of transactions under  Deposits
                  $result = "SELECT count(*) FROM bm_Transactions WHERE  tr_type ='Transfer' ";
                  $stmt = $mysqli->prepare($result);
                  $stmt->execute();
